...
final_df = pd.DataFrame(d[1].values.tolist(), columns=['confirmed', 'recovered', 'deaths'],
...
sorted_df = final_df.sort_values(["confirmed"], ascending=False)
...
app.layout = html.Div(style={'backgroundColor': dash_colors['background']},
                      children=[
                          ...
                          html.P('''Coronavirus disease 2019(COVID-19) is an infectious spreading disease,which is casued by severe acute respiratory syndrome coronavirus 2(SARS-Cov-2).This disease was first found in 2019 in Wuhan distirct of China,
    and is spreading tremendously across the globe,resulted in pandemic declaration by World Health Organization.''',
                                 style={
                                     'color': 'white'
                                 }),
                          html.H2("Confirmed cases: {}".format(confirmed_cases),
                                  style={
                                      'textAlign': 'center',
                                      'color': '#F3AE0F',
                                      'height': 20
                          ...
                          html.H2("Recovered cases: {}".format(recovered_cases),
                                  style={
                                      'textAlign': 'center',
                                      'color': '#F3AE0F',
                                      'height': 20
                          ...
                          html.H2("Deaths: {}".format(deaths),
                                  style={
                                      'textAlign': 'center',
                                      'color': '#F3AE0F',
                                      'height': 20
                                  }),
                          html.H2("Active cases: {}".format(Active),
                                  style={
                                      'textAlign': 'center',
                                      'color': '#F3AE0F',
                                      'height': 20
                          ...
                          dcc.Graph(
                              ...
                              figure={
                                  'data': [
                                      {'x': sorted_df['state'], 'y': sorted_df['confirmed'], 'type': 'bar',
                                       'name': 'confirmed'},
                          ...
                          dash_table.DataTable(
                              ...
                              style_table={
                                  ...
                                  'minWidth': '180px', 'width': '150px', 'maxWidth': '180px', 'textAlign': 'center',
